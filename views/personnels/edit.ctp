...
<?php echo $this->Form->create('Personnel');?>
	<fieldset>
		<legend><?php __('Edit Personnel'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('Personnel.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('Personnel.id'))); ?></li>
