...
<?php echo $this->Form->create('SalleCours');?>
	<fieldset>
		<legend><?php __('Edit Salle Cours'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('SalleCours.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('SalleCours.id'))); ?></li>
