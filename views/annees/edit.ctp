...
<?php echo $this->Form->create('Annee');?>
	<fieldset>
		<legend><?php __('Edit Annee'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('Annee.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('Annee.id'))); ?></li>
